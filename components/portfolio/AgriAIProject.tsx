  ...
  return (
    <ProjectDetail data={{
      ...
      keyFeatures: [
        ...
        'SAR→NDVI gapfill: predicts the optical index when clouds block Sentinel-2. 95.7% of answered pixels within ±0.10 NDVI (MAE 0.034) on 129k held-out pixels, with conformal intervals and an explicit reject option at 28.8% coverage. Self-training with 22k pseudo-labels per fold changed nothing, and the deck says so.',
